            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Etkinlik</a></li>
                  ...
                  <li class="nav-item"><a class="nav-link"  href="/blog/blog_logout.php" role="button"><i>Çıkış Yap</i></a></li>
